...
window.GameMap = (function () {
  ...
  // ── Materials ──────────────────────────────────────────
  const M = {
    floor:    new THREE.MeshLambertMaterial({ color: 0xe8dfc8 }),
    wall:     new THREE.MeshLambertMaterial({ color: 0xf2ede4 }),
    ceiling:  new THREE.MeshLambertMaterial({ color: 0xfaf8f4 }),
    desk:     new THREE.MeshLambertMaterial({ color: 0x8b7355 }),
    glass:    new THREE.MeshLambertMaterial({ color: 0x88ccff, transparent: true, opacity: 0.3 }),
    frame:    new THREE.MeshLambertMaterial({ color: 0x4a3728 }),
    door:     new THREE.MeshLambertMaterial({ color: 0x7a6a50 }),
    pillar:   new THREE.MeshLambertMaterial({ color: 0xe2ddd0 }),
    pedestal: new THREE.MeshLambertMaterial({ color: 0xcccccc }),
    crown:    new THREE.MeshLambertMaterial({ color: 0xffd700 }),
    terminal: new THREE.MeshLambertMaterial({ color: 0x1a1a2e }),
    exit:     new THREE.MeshLambertMaterial({ color: 0x00ff88, transparent: true, opacity: 0.7 }),
    keycards: {
      yellow: new THREE.MeshLambertMaterial({ color: 0xf0c040 }),
      blue:   new THREE.MeshLambertMaterial({ color: 0x4a9eff }),
      red:    new THREE.MeshLambertMaterial({ color: 0xe05050 }),
    },
    paintings: [
