...
(function () {
  ...
  const MISSION_VARIANTS = [
    ...
    {
      name: 'The Laurel Conspiracy',
      objOrder: ['enter', 'yellow', 'gallery', 'painting', 'crown', 'escape'],
      objectives: {
        enter:    'Infiltrate the Louvre',
        yellow:   'Find the Yellow Keycard',
        gallery:  'Reach the Grande Galerie',
        painting: 'Steal the Golden Laurel Crown (Salle des Statues)',
        crown:    'Steal the Marble Bust of Augustus (Salle des Statues)',
        escape:   'Slip out before dawn',
      },
      stealConfig: [
        { label: 'Golden Laurel Crown',      mapTo: 'painting' },
        { label: 'Marble Bust of Augustus',  mapTo: 'crown'    },
      ],
      winItems: ['painting', 'crown'],
      rooms: 4,
      navTargets: {
    ...
    {
      name: 'The Grand Sweep',
      objOrder: ['enter', 'yellow', 'gallery', 'painting', 'blue', 'crown', 'escape'],
      objectives: {
        enter:    'Enter the Louvre',
        yellow:   'Find the Yellow Keycard',
        gallery:  'Reach the Grande Galerie',
        painting: 'Steal the Marble Bust of Augustus (Salle des Statues)',
        blue:     'Find the Blue Keycard',
        crown:    "Steal the Pharaoh's Scepter (Egyptian Catacomb)",
        escape:   'Escape with both trophies',
      },
      stealConfig: [
        { label: 'Marble Bust of Augustus', mapTo: 'painting' },
        { label: "Pharaoh's Scepter",       mapTo: 'crown'    },
      ],
      winItems: ['painting', 'crown'],
      rooms: 5,
